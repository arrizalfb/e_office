  ...
  <div class="main-content-inner">
    <div class="row">
      ...
      <div class="col-12 mt-4">
        <div class="card">
          <div class="card-body">
            <h4 class="header-title">Status Data Table List Faktur Pajak</h4>
...
<div class="modal fade" id="Edit{{$lfp->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <script>
        function tampilkan(){
          var nama_kota=document.getElementById("form5").detail.value;
          if (nama_kota=="Sudah"){
                document.getElementById("tampil").innerHTML=
                "<input type='text' id='ntpn' class='form-control'name='ketstat' placeholder='Masukkan No. NTPN, Nominal, Tanggal, Bank, Cara Pembayaran'>";
          }else{
                document.getElementById("tampil").innerHTML="";
          }
        }
      ...
      <div class="modal-body">
        <form id="form5" method="post" action="/listfakturpajak/status/{{$lfp->id}}">
          {{ csrf_field() }}
          {{ method_field('PUT') }}
          <div class="box-body">
            ...
            <div class="form-group">
              <label>Pilih Kategori: </label>
                <select id="detail" name="statusfaktur" class="form-control" onchange="tampilkan()">
