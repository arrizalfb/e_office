    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="dashboard"><img src="{{ asset('assets/images/icon/basic.jpg') }}" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
   ...
   <div class="main-content">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">SuperAdmin <i class="fa fa-angle-down"></i></h4>
        ...
        <footer>
            <div class="footer-area">
                <p>©  2020 Basic Teknologi - All Rights Reserved.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
